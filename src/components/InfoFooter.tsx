      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm opacity-80 mb-2">
            Trang web được tạo ra để buôn bán giày dép các loại, chuyên cung cấp giày dép uy tín, chất lượng.
            Với tinh thần làm việc hăng hái, tận tụy với khách hàng, chúng tôi cam kết mang đến những trải nghiệm quý giá nhất đến với khách hàng.
          </p>
          <div className="text-sm opacity-80 space-y-1">
            <p>Khi cần bạn hãy liên hệ theo số sau:</p>
            <p>+ 84 1234567899</p>
